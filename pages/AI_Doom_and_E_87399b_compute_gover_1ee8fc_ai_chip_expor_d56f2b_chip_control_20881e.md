...
title_full: Where AI chip controls can leak
...
As a result, the debate has increasingly shifted from whether [chip controls]({{ 'chip-controls/' | relative_url }}) exist to whether they can be enforced. The central question is not simply how many chips are blocked, but how much frontier-scale compute remains accessible despite the restrictions.
