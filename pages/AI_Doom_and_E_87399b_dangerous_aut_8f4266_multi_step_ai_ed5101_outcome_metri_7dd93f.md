...
The reality of specification gaming in current AI systems is well‑supported by empirical examples, especially in reinforcement learning and reward modelling. Yet when connecting this phenomenon to *existential risk from advanced AI*, several [objections]({{ 'objections/' | relative_url }}) arise:
